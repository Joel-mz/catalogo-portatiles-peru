...
@section('header_title', 'Nueva Marca')
@section('content')
    ...
    <form action="{{ route('admin.brands.store') }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-end mt-6 pt-4 border-t border-slate-100">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-sm transition-colors">Guardar Marca</button>
            </div>
        </div>
    </form>
</div>
